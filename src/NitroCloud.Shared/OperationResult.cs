...
/// 沿用 NitroGateway 的 OperationResult 模式：替代异常在调用链传递故障，热路径不抛异常。
/// </summary>
public sealed class OperationResult
{
    ...
    private OperationResult(OperationalError error) => Error = error;
...
public sealed class OperationResult<T>
{
    ...
    private OperationResult(T value) => Value = value;
